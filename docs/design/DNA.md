...
| PWA | Tiap prefix peran (`/customer/*`, `/merchant/*`, `/courier/*`, `/admin/*`) punya boot screen tanpa jeda buatan dan manifest sendiri; scroll native dan safe area tetap hidup | `index.html`, manifest per peran, audit gestur |
