...
Terakhir diperbarui: 2026-09-22 — **tip kurir digabung di layar pasca-order** (keputusan PO 2026-09-22): prompt jadi "nilai + tip", node form jadi "teks, tag & tip"; aturan tip dari PRD §Tips, withdraw di `f6`, **fee payout ditanggung kurir** (PO 2026-09-22). Validate 9/9 pass, deliver exit 0 (spec `02c7c5f2`, artifact `9e7afd2a`), visual-check pass (1440x900, 2048x1320 light + dark, overflow 0).
