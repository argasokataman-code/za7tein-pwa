...
| OQ-29 | Dispute: finalisasi window 24 jam, kategori sengketa, SLA resolusi | UNRESOLVED (ditunda sampai volume > 5/bulan) |
| OQ-30 | Dispute: siapa "super admin" secara operasional | UNRESOLVED |
...
| I-3 | Insentif: cashback masuk dompet deposit merchant — non-withdrawal atau bisa ditarik | UNRESOLVED |
...
| I-6 | Insentif: sisa modal 5 JOD kalau merchant berhenti — hangus atau utang | UNRESOLVED |
