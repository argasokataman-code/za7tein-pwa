...
export default function Landing() {
  ...
  return <div className="sa-landing" ref={landingRef}>
    <header className="sa-nav"><div className="sa-wrap sa-nav-inner">
      ...
      <div className="sa-nav-actions"><a href="/customer/signin" className="sa-nav-login">Masuk</a><a href="/customer/onboarding" className="sa-button sa-button-dark">Mulai Pesan</a></div>
      <details className="sa-mobile-nav"><summary aria-label="Buka navigasi"><Menu size={22} strokeWidth={1.75} /></summary><nav aria-label="Navigasi ponsel"><a href="#cara-kerja">Cara Kerja</a><a href="#untuk-toko">Untuk Merchant</a><a href="#area">Area</a><a href="#tentang">Tentang</a><a href="/customer/signin">Masuk</a><a href="/customer/onboarding">Mulai Pesan</a></nav></details>
    </div></header>
    <main>
      <section className="sa-sample-hero" aria-labelledby="sa-hero-title"><div className="sa-wrap sa-sample-hero-inner">
        <div className="sa-sample-hero-copy"><p>Marketplace makanan hyperlocal</p><h1 id="sa-hero-title">Makanan enak,<br />lebih dekat.</h1><p>Temukan makanan dari dapur terdekat, pesan dengan mudah, dan nikmati pengantaran langsung dari kurir toko.</p><div className="sa-sample-actions"><a href="/customer/onboarding" className="sa-button sa-button-cream">Mulai Pesan <ArrowRight size={17} strokeWidth={1.75} /></a><a href="#cara-kerja" className="sa-button sa-button-outline">Lihat Cara Kerja</a></div></div>
      ...
      <section className="sa-merchant-feature" id="untuk-toko"><div className="sa-wrap sa-merchant-feature-grid">
        ...
        <div className="sa-merchant-feature-copy"><p className="sa-section-kicker">04 / UNTUK MERCHANT</p><h2>Dapur tetap fokus. Pesanan tetap tertata.</h2><p>Tiket masuk, waktu masak, menu, dan stok dibaca dalam satu alur ketika dapur sedang ramai.</p><a href="/merchant" className="sa-button sa-button-dark">Lihat untuk Merchant <ArrowRight size={17} strokeWidth={1.75} /></a></div>
      </div></section>
      <section className="sa-courier-feature" id="tentang"><div className="sa-wrap sa-courier-feature-grid">
        <div className="sa-courier-feature-copy"><p className="sa-section-kicker">05 / UNTUK KURIR TOKO</p><h2>Satu perjalanan. Tujuan jelas.</h2><p>Alamat dan progres pengantaran disajikan sederhana agar kurir toko bisa fokus membawa pesanan sampai ke pelanggan.</p><a href="/courier" className="sa-feature-link">Lihat alur kurir <ArrowRight size={18} strokeWidth={1.75} /></a></div>
      ...
      <section className="sa-food-feature"><div className="sa-wrap sa-food-feature-grid"><div><p className="sa-section-kicker">06 / RASA SEKITAR</p><h2>Banyak rasa lokal di sekitarmu.</h2><p>Dari menu harian sampai favorit yang selalu dicari, temukan pilihan dari dapur yang melayani areamu.</p><a href="/customer/home" className="sa-feature-link">Jelajahi menu <ArrowRight size={18} strokeWidth={1.75} /></a></div><div className="sa-food-feature-photo"><img src="/assets/img/menu/nasi-goreng.webp" alt="Nasi goreng dari menu contoh" loading="lazy" /></div></div></section>
      <section className="sa-sample-final" aria-labelledby="sa-final-title">
        <div className="sa-wrap sa-final-content">
          <div className="sa-final-copy">
            ...
            <a href="/customer/onboarding" className="sa-button sa-button-cream sa-final-primary">Cari makanan <ArrowRight size={18} strokeWidth={1.75} /></a>
            <div className="sa-final-merchant"><span>Punya dapur atau toko makanan?</span><a href="/merchant/signup">Bergabung sebagai merchant <ArrowRight size={16} strokeWidth={1.75} /></a></div>
          </div>
        </div>
