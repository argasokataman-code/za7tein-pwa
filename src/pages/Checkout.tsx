        ...
        <div className="checkout-screen">
          ...
          <div className="checkout-empty-state">
            <div className="empty-cart-icon">
              <svg xmlns="http://www.w3.org/2000/svg" width={52} height={52} viewBox="0 0 24 24" fill="none" stroke="#F15A37" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-shopping-bag">
