  ...
  return (
    ...
    <div className="app-shell">
      <div style={{ minHeight: "100dvh", background: "rgb(0, 0, 0)", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "24px 32px", textAlign: "center", fontFamily: "var(--font-plus-jakarta), 'Plus Jakarta Sans', sans-serif" }}>
        ...
        <button type="button" style={{ height: "56px", padding: "0px 32px", background: "rgb(253, 105, 49)", color: "rgb(255, 255, 255)", borderWidth: "medium", borderStyle: "none", borderColor: "currentcolor", borderImage: "none", borderRadius: "9999px", fontWeight: "600", fontSize: "16px", cursor: "pointer", fontFamily: "inherit" }}>
          Retry
        </button>
      </div>
    </div>
