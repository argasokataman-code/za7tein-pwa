...
export default function OrderDelivery() {
  const { recenter } = useLeafletMap("delivery-map")
  const navigate = useNavigate()
  useEffect(() => {
    document.body.className = "order-delivery-page"
    return () => {
      ...
      <main>
        <div className="order-delivery-screen">
          ...
          <div className="order-details-panel">
            ...
            <div className="progress-tracker">
              ...
              <div style={{ display: "contents" }}>
                <div className="progress-step active">
                  <div className="step-icon delivery-step-icon">
                    <svg width={22} height={22} viewBox="0 0 22 22" fill="none">
                      <path d="M1 10H21M1 10L5 6M1 10L5 14M8 6H21M8 18H21M8 6V18" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <span className="step-label">
                    Out for Delivery
            ...
            <div className="order-status-message delivery-status">
              <div className="status-icon delivery-status-icon">
                <svg width={16} height={16} viewBox="0 0 24 24" fill="none">
                  <rect x="1" y="3" width={15} height={13} rx="1" stroke="white" strokeWidth="2" />
              ...
              <div className="status-text">
                ...
                <p className="status-subtitle">
                  Your order is being delivered to your address
                </p>
              </div>
            </div>
          </div>
