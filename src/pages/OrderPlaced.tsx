...
export default function OrderPlaced() {
  ...
  return (
    ...
    <div className="app-shell">
      <main>
        <div className="order-placed-screen">
          <header className="order-placed-header">
            ...
            <div className="progress-tracker">
              ...
              <div style={{ display: "contents" }}>
                <div className="progress-step">
                  <div className="step-icon">
                    <svg width={22} height={22} viewBox="0 0 22 22" fill="none">
                      <path d="M1 10H21M1 10L5 6M1 10L5 14M8 6H21M8 18H21M8 6V18" stroke="#697586" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <span className="step-label">
                    Out for Delivery
              ...
              <div style={{ display: "contents" }}>
                <div className="progress-step">
                  <div className="step-icon">
                    <svg width={22} height={22} viewBox="0 0 22 22" fill="none">
                      <path d="M2.2002 11.5502C2.2002 10.6389 2.93893 9.9002 3.8502 9.9002C4.76147 9.9002 5.5002 10.6389 5.5002 11.5502V18.1502C5.5002 19.0615 4.76147 19.8002 3.8502 19.8002C2.93893 19.8002 2.2002 19.0615 2.2002 18.1502V11.5502Z" fill="#697586" />
                      <path d="M6.6002 11.3669V17.3405C6.6002 18.1738 7.071 18.9356 7.81633 19.3083L7.87116 19.3357C8.48212 19.6412 9.15582 19.8002 9.8389 19.8002H15.7966C16.8453 19.8002 17.7482 19.06 17.9539 18.0317L19.2739 11.4317C19.5462 10.0703 18.5049 8.8002 17.1166 8.8002H13.2002V4.4002C13.2002 3.18517 12.2152 2.2002 11.0002 2.2002C10.3927 2.2002 9.9002 2.69268 9.9002 3.3002V4.03353C9.9002 4.98556 9.59141 5.91191 9.0202 6.67353L7.4802 8.72686C6.90898 9.48849 6.6002 10.4148 6.6002 11.3669Z" fill="#697586" />
                    </svg>
                  </div>
                  <span className="step-label">
                    Delivered
            ...
            <div className="order-status-message">
              <div className="status-icon">
                <svg width={16} height={16} viewBox="0 0 16 16" fill="none">
                  <path d="M7.2002 1.59961C6.75837 1.59961 6.4002 1.95778 6.4002 2.39961C6.4002 2.84144 6.75837 3.19961 7.2002 3.19961H8.80019C9.24202 3.19961 9.60019 2.84144 9.60019 2.39961C9.60019 1.95778 9.24202 1.59961 8.80019 1.59961H7.2002Z" fill="white" />
                  <path fillRule="evenodd" clipRule="evenodd" d="M3.2002 3.99961C3.2002 3.11595 3.91654 2.39961 4.8002 2.39961C4.8002 3.72509 5.87471 4.79961 7.2002 4.79961H8.80019C10.1257 4.79961 11.2002 3.72509 11.2002 2.39961C12.0839 2.39961 12.8002 3.11595 12.8002 3.99961V12.7996C12.8002 13.6833 12.0839 14.3996 11.2002 14.3996H4.8002C3.91654 14.3996 3.2002 13.6833 3.2002 12.7996V3.99961ZM10.9659 8.56529C11.2783 8.25288 11.2783 7.74634 10.9659 7.43392C10.6535 7.1215 10.1469 7.1215 9.83451 7.43392L7.2002 10.0682L6.16588 9.03392C5.85346 8.7215 5.34693 8.7215 5.03451 9.03392C4.72209 9.34634 4.72209 9.85288 5.03451 10.1653L6.63451 11.7653C6.94693 12.0777 7.45346 12.0777 7.76588 11.7653L10.9659 8.56529Z" fill="white" />
                </svg>
              </div>
