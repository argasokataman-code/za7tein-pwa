...
export default function OrderDelivered() {
  useEffect(() => {
    document.body.className = "order-delivered-page"
    return () => {
  ...
  return (
    ...
    <div className="app-shell">
      <main>
        <div className="order-delivered-screen">
          <header className="order-delivered-header">
          ...
          <div className="order-details-panel">
            ...
            <div className="progress-tracker">
                ...
                <div className="progress-step completed">
                  <div className="step-icon">
                    <svg width={22} height={22} viewBox="0 0 22 22" fill="none">
                      <path d="M9.8999 2.2002C9.29239 2.2002 8.7999 2.69268 8.7999 3.3002C8.7999 3.90771 9.29239 4.4002 9.8999 4.4002H12.0999C12.7074 4.4002 13.1999 3.90771 13.1999 3.3002C13.1999 2.69268 12.7074 2.2002 12.0999 2.2002H9.8999Z" fill="#FF6B35" />
                      <path fillRule="evenodd" clipRule="evenodd" d="M4.3999 5.5002C4.3999 4.28517 5.38488 3.3002 6.5999 3.3002C6.5999 5.12274 8.07736 6.6002 9.8999 6.6002H12.0999C13.9224 6.6002 15.3999 5.12274 15.3999 3.3002C16.6149 3.3002 17.5999 4.28517 17.5999 5.5002V17.6002C17.5999 18.8152 16.6149 19.8002 15.3999 19.8002H6.5999C5.38488 19.8002 4.3999 18.8152 4.3999 17.6002V5.5002ZM15.0777 11.778C15.5073 11.3484 15.5073 10.652 15.0777 10.2224C14.6481 9.7928 13.9517 9.7928 13.5221 10.2224L9.8999 13.8446L8.47772 12.4224C8.04814 11.9928 7.35166 11.9928 6.92208 12.4224C6.49251 12.852 6.49251 13.5484 6.92208 13.978L9.12209 16.178C9.55166 16.6076 10.2481 16.6076 10.6777 16.178L15.0777 11.778Z" fill="#FF6B35" />
                    </svg>
                  </div>
              ...
              <div style={{ display: "contents" }}>
                <div className="progress-step completed">
                  <div className="step-icon">
                    <svg width={22} height={22} viewBox="0 0 22 22" fill="none">
                      <path d="M1 10H21M1 10L5 6M1 10L5 14M8 6H21M8 18H21M8 6V18" stroke="#FF6B35" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                  <span className="step-label">
                    Out for Delivery
              ...
              <div style={{ display: "contents" }}>
                <div className="progress-step active">
                  <div className="step-icon delivered-step-icon">
                    <svg width={22} height={22} viewBox="0 0 22 22" fill="none">
                      <path d="M2.2002 11.5502C2.2002 10.6389 2.93893 9.9002 3.8502 9.9002C4.76147 9.9002 5.5002 10.6389 5.5002 11.5502V18.1502C5.5002 19.0615 4.76147 19.8002 3.8502 19.8002C2.93893 19.8002 2.2002 19.0615 2.2002 18.1502V11.5502Z" fill="white" />
                      <path d="M6.6002 11.3669V17.3405C6.6002 18.1738 7.071 18.9356 7.81633 19.3083L7.87116 19.3357C8.48212 19.6412 9.15582 19.8002 9.8389 19.8002H15.7966C16.8453 19.8002 17.7482 19.06 17.9539 18.0317L19.2739 11.4317C19.5462 10.0703 18.5049 8.8002 17.1166 8.8002H13.2002V4.4002C13.2002 3.18517 12.2152 2.2002 11.0002 2.2002C10.3927 2.2002 9.9002 2.69268 9.9002 3.3002V4.03353C9.9002 4.98556 9.59141 5.91191 9.0202 6.67353L7.4802 8.72686C6.90898 9.48849 6.6002 10.4148 6.6002 11.3669Z" fill="white" />
                    </svg>
                  </div>
                  <span className="step-label">
                    Delivered
            ...
            <div className="order-status-message delivered-status">
              <div className="status-icon delivered-status-icon">
                <svg width={16} height={16} viewBox="0 0 24 24" fill="none">
                  <path d="M14 9V5a3 3 0 0 0-3-3l-4 9v11h11.28a2 2 0 0 0 2-1.7l1.38-9a2 2 0 0 0-2-2.3H14Z" stroke="white" strokeWidth="2" strokeLinejoin="round" />
                  <path d="M7 22H4a2 2 0 0 1-2-2v-7a2 2 0 0 1 2-2h3" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
            ...
            <div style={{ marginTop: "20px" }}>
              <button className="delivered-home-btn" style={{ width: "100%" }}>
                Done
              </button>
            </div>
          </div>
