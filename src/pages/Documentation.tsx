        ...
        <main className="doc-main">
          <div className="doc-hero">
            ...
            <p className="doc-hero-desc">
              Panduan PWA Sa7tein: tiap peran punya prefix URL dan instalasi sendiri (/customer, /merchant, /courier, /admin — panel admin yang dikelola CS). Super Admin adalah role terpisah: website penuh non-PWA di /superadmin, dengan Ringkasan berupa dashboard chart tulis tangan (donut + bar, tanpa library). Landing dengan satu aksi utama per section, cache yang aman, scroll native, dan simulator desktop yang scroll-nya terkunci pada layar perangkat. Kartu promo beranda kini bergaya kartu (lingkaran sepusat di atas oranye merek, tanpa gradient) dengan bilah aksi selebar kartu. Beranda dapur merchant memakai hero oranye bergaya beranda pelanggan (bidang + pola gelombang bersama) yang menyatukan identitas toko, status buka/tutup, dan kuota harian; modal aplikasi di-portal ke body supaya tidak lagi tertutup bilah nav. Konfirmasi merchant kini seragam lewat ConfirmSheet dengan dua tombol sejajar, dan kepala tiap grup kategori di daftar menu menempel tepat di bawah bar filter (offset diukur runtime) sehingga label kategori tetap terbaca saat digulir. Menu merchant disaring per kategori (chip Makanan/Minuman/Camilan) plus status stok di satu bar sticky, dan daftar dikelompokkan per kategori.
            </p>
